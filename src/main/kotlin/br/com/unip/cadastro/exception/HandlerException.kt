...
import br.com.unip.cadastro.exception.ECodigoErro.ACESSO_NEGADO
import br.com.unip.cadastro.exception.ECodigoErro.CONEXAO_RECUSADA
import br.com.unip.cadastro.exception.ECodigoErro.ERRO_INESPERADO
import br.com.unip.cadastro.webservice.model.response.erro.Erro
import br.com.unip.cadastro.webservice.model.response.erro.ResponseError
...
class HandlerException(val mapper: ObjectMapper, val messageSource: MessageSource) {
    ...
    @ExceptionHandler(CadastroBaseException::class)
    fun handlerCadastroException(e: CadastroBaseException): ResponseEntity<ResponseError> {
