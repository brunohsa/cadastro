...
class CampoCNPJValido : ICampo<String> {
    ...
    constructor(cnpj: String?) {
        try {
            ...
            throw CampoNumericoException("CNPJ inválido", ECodigoErro.CAD008)
        } catch (e: CampoObrigatorioException) {
            throw CampoObrigatorioException("CNPJ é obrigatório", ECodigoErro.CAD009)
        }
    }
    ...
    private fun cnpjValido(original: String): String {
        ...
        if (value != cnpjCalc) {
            throw ParametroInvalidoException("CNPJ inválido", ECodigoErro.CAD006)
        }
